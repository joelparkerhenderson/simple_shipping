...
* {http://fedex.com FedEx}
* {http://ups.com UPS}

== Entities

The main entities you probably want to have a deal with are:

* {SimpleShipping::Party Party}
* {SimpleShipping::Contact Contact}
* {SimpleShipping::Address Address}
* {SimpleShipping::Package Package}
* {SimpleShipping::Base::Response Response}
...
== Usage
    ...
    # NOTE: 
    #  FedEx returns image in PNG format
    #  UPS returns image in GIF format
    ups_resp.save_label_as_gif("ups_label.gif")
    fedex_resp.save_label_as_png("fedex_label.png")
...
* :packaging_type (see {SimpleShipping::Fedex::ShipmentBuilder::PACKAGING_TYPES} for available values)
...
== TODO
* More documentation for entities(party, contact, address, etc.)
* Write specs
* Common interface for service types, packaging type.
